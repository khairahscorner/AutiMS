                    ...
                    <div class="col-md-6 pt-10">
                        <form>
                            ...
                            <div class="pt-10 form-group">
                                    ...
                                    <input type="text" disabled v-model="relationship" class="form-control" id="relationship">
                                </div>
                            <div class="form-group pt-10">
                                <label for="child_name">Child Name</label>
                                <input disabled v-model="child_name" type="text" class="form-control" id="child_name">
                            </div>
                            <div class="row">
                                <div class="col-6 form-group">
                                    <label for="age">Child Age</label>
                                    <input type="number" disabled v-model="child_age" class="form-control" id="child_age">
                                </div>
                                <div class="col-6 form-group">
                                            <label for="child_gender">Gender</label>
                                            <multiselect disabled v-model="child_gender" :options="['Male', 'Female']"
...
export default {
    ...
    methods: {
      ...
      saveDetails() {
        let userData = {
          ...
          axios.put(`/caregiver/${this.id}`, userData)
          .then(res => {
  ...
  mounted() {
        ...
        this.name = store.state.caregiver_details.name
        this.phone_no = store.state.caregiver_details.phone_no
        this.relationship = store.state.caregiver_details.relationship
        this.child_name = store.state.caregiver_details.child_name
        this.child_age = store.state.caregiver_details.child_age
        this.child_gender = store.state.caregiver_details.child_gender
        this.img_url = store.state.caregiver_details.img_url
        this.email = store.state.caregiver_details.email
  }
}
</script>