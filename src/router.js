  ...
  routes: [
    ...
    // Parent section
    {
      ...
      children: [
        ...
        { path: "/parent/profile/edit", component: () => import("./views/parent/EditProfile.vue"), meta: {title: 'Edit Profile', reqToken: true} },
        ...
        { path: "/parent/observation-reports/new", component: () => import("./components/parentcaregiver/observationreports/CreateObservationReport.vue"), meta: {title: 'New Observation Report', reqToken: true} },
    ...
    // Caregiver section
    {
      ...
      children: [
        ...
        { path: "/profile/edit", component: () => import("./views/caregiver/EditProfile.vue"), meta: {title: 'Edit Profile', reqToken: true} },
        ...
        { path: "/observation-reports/new", component: () => import("./components/parentcaregiver/observationreports/CreateObservationReport.vue"), meta: {title: 'New Observation Report', reqToken: true} },
      ],
      beforeEnter(to, from, next) {
        let userToken = allMixins.methods.retrieveToken(window.btoa('userToken'))
        let details = Vue.$jwt.decode(userToken)
